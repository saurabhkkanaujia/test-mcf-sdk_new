...
/**
     ...
     * @return \Ced\Model\GetInventorySummariesResponse|\Ced\Model\GetInventorySummariesResponse|\Ced\Model\GetInventorySummariesResponse|\Ced\Model\GetInventorySummariesResponse|\Ced\Model\GetInventorySummariesResponse|\Ced\Model\GetInventorySummariesResponse|\Ced\Model\GetInventorySummariesResponse
     */
    ...
    public function getInventorySummariesWithHttpInfo($granularity_type, $granularity_id, $marketplace_ids, $details = false, $start_date_time = null, $seller_skus = null, $next_token = null, string $contentType = self::contentTypes['getInventorySummaries'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ced\Model\GetInventorySummariesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ced\Model\GetInventorySummariesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ced\Model\GetInventorySummariesResponse', []),
            ...
            $returnType = '\Ced\Model\GetInventorySummariesResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ced\Model\GetInventorySummariesResponse',
