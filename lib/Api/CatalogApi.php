...
/**
     ...
     * @return \Ced\Model\Item|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList
     */
     ...
     * @throws \Ced\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ced\Model\Item|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCatalogItemWithHttpInfo($asin, $marketplace_ids, $included_data = null, $locale = null, string $contentType = self::contentTypes['getCatalogItem'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ced\Model\Item' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ced\Model\Item' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ced\Model\Item', []),
     ...
     * @throws \Ced\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ced\Model\ItemSearchResults|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList
     */
     ...
     * @throws \Ced\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ced\Model\ItemSearchResults|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList|\Ced\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCatalogItemsWithHttpInfo($marketplace_ids, $identifiers = null, $identifiers_type = null, $included_data = null, $locale = null, $seller_id = null, $keywords = null, $brand_names = null, $classification_ids = null, $page_size = 10, $page_token = null, $keywords_locale = null, string $contentType = self::contentTypes['searchCatalogItems'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ced\Model\ItemSearchResults' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ced\Model\ItemSearchResults' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ced\Model\ItemSearchResults', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Ced\Model\ItemSearchResults';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
